...
**A note on validation**: ESG scores tend to remain relatively stable over time within the same firm, with differences between firms being approximately 2.6 times greater than changes observed within firms. All train/test partitions and cross-validation
